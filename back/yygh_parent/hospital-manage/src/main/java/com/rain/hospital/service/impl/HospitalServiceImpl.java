...
import com.rain.hospital.mapper.OrderInfoMapper;
import com.rain.hospital.mapper.ScheduleMapper;
import com.rain.hospital.model.OrderInfo;
import com.rain.hospital.model.Patient;
import com.rain.hospital.model.Schedule;
import com.rain.hospital.service.HospitalService;
import com.rain.hospital.util.ResultCodeEnum;
...
public class HospitalServiceImpl implements HospitalService {
    ...
    public Map<String, Object> submitOrder(Map<String, Object> paramMap) {
        ...
        if(availableNumber > 0) {
            ...
            //取号时间
            String date = new DateTime(reserveDate).toString("yyyy年MM月dd日");
            resultMap.put("fetchTime", date + "09:00前");;
            //取号地址
