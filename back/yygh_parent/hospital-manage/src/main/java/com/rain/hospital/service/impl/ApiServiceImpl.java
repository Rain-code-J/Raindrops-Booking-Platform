package com.rain.hospital.service.impl;

import com.alibaba.fastjson.JSONArray;
import com.alibaba.fastjson.JSONObject;
import com.rain.hospital.mapper.HospitalSetMapper;
import com.rain.hospital.mapper.ScheduleMapper;
import com.rain.hospital.model.HospitalSet;
import com.rain.hospital.model.Schedule;
import com.rain.hospital.service.ApiService;
import com.rain.hospital.util.BeanUtils;
import com.rain.hospital.util.HttpRequestHelper;
import com.rain.hospital.util.YyghException;
...
public class ApiServiceImpl implements ApiService {
    ...
    public boolean saveHospital(String data) {
        ...
        String url = this.getApiUrl()+"/api/hosp/saveHospital";

        JSONObject respone =
                HttpRequestHelper.sendRequest(paramMap,url);
        System.out.println(respone.toJSONString());
